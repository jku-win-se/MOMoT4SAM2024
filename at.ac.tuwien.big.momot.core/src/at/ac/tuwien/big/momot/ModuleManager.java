...
public class ModuleManager {
   ...
   public <T extends Assignment> T assignParameterValues(final T assignment) {
      ...
      for(final Parameter parameter : assignment.getUnit().getParameters()) {
         final Object value = nextParameterValue(parameter, paramValues);
         if(value != null) {
            assignment.setParameterValue(parameter, value);
            paramValues.put(parameter.getName(), value);
         }
      }
   ...
   public <T extends Object> T nextParameterValue(final Parameter parameter, final Class<T> valueType,
      ...
      return CastUtil.asClass(nextParameterValue(parameter, paramValues), valueType);
   }

   // convenience methods to get next parameter value

   public Object nextParameterValue(final Parameter parameter, final Map<String, Object> paramValues) {
      final IParameterValue<?> value = parameterValues.get(parameter);
      if(value == null) {
         return null;
      }
      return value.nextValue(paramValues);
   }

   public <T extends Object> T nextParameterValue(final String qualifiedParameterName, final Class<T> valueType,
         final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(qualifiedParameterName), valueType, paramValues);
   }

   public Object nextParameterValue(final String qualifiedParameterName, final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(qualifiedParameterName), paramValues);
   }

   public <T extends Object> T nextParameterValue(final String qualifiedUnitName, final String parameterName,
         final Class<T> valueType, final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(qualifiedUnitName, parameterName), valueType, paramValues);
   }

   public Object nextParameterValue(final String qualifiedUnitName, final String parameterName,
         final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(qualifiedUnitName, parameterName), paramValues);
   }

   public <T extends Object> T nextParameterValue(final String moduleName, final String unitName,
         final String parameterName, final Class<T> valueType, final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(moduleName, unitName, parameterName), valueType, paramValues);
   }

   public Object nextParameterValue(final String moduleName, final String unitName, final String parameterName,
         final Map<String, Object> paramValues) {
      return nextParameterValue(getParameter(moduleName, unitName, parameterName), paramValues);
   }
